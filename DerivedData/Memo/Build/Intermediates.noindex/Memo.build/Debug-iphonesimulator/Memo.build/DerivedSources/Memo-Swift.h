...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Memo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Memo11AppDelegate")
...
SWIFT_CLASS("_TtC4Memo18MemoViewController")
@interface MemoViewController : UIViewController <UITextFieldDelegate>
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified titleTextField;
@property (nonatomic, strong) IBOutlet UITextView * _Null_unspecified contentTextView;
- (void)viewDidLoad;
- (IBAction)save;
...
SWIFT_CLASS("_TtC4Memo13SceneDelegate")
...
SWIFT_CLASS("_TtC4Memo14ViewController")
